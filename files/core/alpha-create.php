...
if (isset($_POST['action']) && ($_POST['action'] == 'alpha-create')) {
	$acc = new accounts();
	$res = $acc->whmseller_g($_POST['domain'], $_POST['username'], $_POST['password'], $_POST['email'], $_POST['maxdomains'], $_POST['masters'], $_POST['diskspace'], $_POST['bandwidth'], $_POST['diskoversell'], $_POST['bwoversell'], '0', $_POST['package']);
	jsonOut($res);
}
