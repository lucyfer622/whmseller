...
<div class="card-body"><b>1.</b>You need to be download whmcsmoudle.zip<br><b>2.</b>Upload zip file on whmcs root directory and extract.<br><b>3.</b> Create Server from WHMCS Admin Panel. Under Server details, choose WHMSELLER.<br><b>4.</b> Under Setup > Products/Services, Create a Reseller Package. In Module Settings Tab, Choose WHMSELLER as Module Name.<br><b>5.</b> Complete the form and choose the option for Account to Create.<br>If you need anykind of help, Open a support ticket<b><a href="https://github.com/lucyfer622/whmseller/issues"> #Needsupport</b></a>
</div>
