...
if (isset($_POST['action']) && ($_POST['action'] == 'master-create')) {
  $acc = new accounts();
  $res = $acc->createmaster($_POST['domain'], $_POST['username'], $_POST['password'], $_POST['email'], $_POST['maxdomains'], $_POST['resellers'], $_POST['diskspace'], $_POST['bandwidth'], $_POST['diskoversell'], $_POST['bwoversell'], 0, 'null', $_POST['package']);
  jsonOut($res);
}
...
echo '</div>'."\r\n".'</div>'."\r\n".'</div></div>'."\r\n".'</div>'."\r\n".'</div>'."\r\n".'<div class="col-md-6">'."\r\n".'<div class="card">'."\r\n".'<div class="card-body">'."\r\n".'<div class="form-group row">'."\r\n".'<label for="inputEmail" class="col-4 col-form-label">E-mail</label> '."\r\n".' <div class="col-8">'."\r\n".'<input id="inputEmail" name="email" placeholder="abc@gmail.com" type="text" class="form-control here">'."\r\n".'</div>'."\r\n".' </div>'."\r\n".'<div class="form-group row">'."\r\n".'<label for="diskspace" class="col-4 col-form-label">Disk Space</label>'."\r\n".'<div class="col-8">'."\r\n".'<div class="input-group">'."\r\n".'<input id="diskspace" name="diskspace" placeholder="Add Number or UNLIMITED" type="text" class="form-control here"> '."\r\n".'<div class="input-group-addon append">MB</div>'."\r\n".'</div>'."\r\n".'</div>'."\r\n".'</div> '."\r\n".'<div class="form-group row">'."\r\n".'<label class="col-4">Overselling</label> '."\r\n".'<div class="col-8 text-left">'."\r\n".'<label class="">'."\r\n".'<input type="checkbox" name="diskoversell" id="inputdsos" value="1">'."\r\n".'<span class="custom-control-indicator"></span> '."\r\n".'<span class="custom-control-description">Can oversell Disk Space.</span>'."\r\n".' </label>'."\r\n".'</div>'."\r\n".'</div>'."\r\n".'<div class="form-group row">'."\r\n".'
  ...
  </div><div class="form-group row">'."\r\n".'<label class="col-4">Overselling</label> '."\r\n".'<div class="col-8 text-left">'."\r\n".'<label class="">'."\r\n".' <input type="checkbox" name="bwoversell" value="1" id="bwos">'."\r\n".' <span class="custom-control-indicator"></span> '."\r\n".'<span class="custom-control-description">Can oversell Bandwidth.</span>'."\r\n".'</label>'."\r\n".' </div>'."\r\n".'</div> '."\r\n".'</div>'."\r\n".'</div>'."\r\n".'</div>'."\r\n".'</div>'."\r\n".'<div class="form-row text-center mt-3">'."\r\n".'<div class="col-12">'."\r\n".'<input type="hidden" name="action" value="master-create" ><button type="submit" class="btn sz btn-primary" data-backdrop="static" data-keyboard="false" data-toggle="modal" data-target="#loading">Create Master Reseller</button>'."\r\n".' </div>'."\r\n".'</div>'."\r\n".' </form>'."\r\n".'<div class="modal fade" id="loading">' . "\r\n" . '<div class="modal-dialog">' . "\r\n" . ' <div class="modal-content">' . "\r\n" . ' <div class="modal-body">' . "\r\n" . '<img src="process.gif"></div>' . "\r\n" . '</div>' . "\r\n" . '</div>' . "\r\n";
